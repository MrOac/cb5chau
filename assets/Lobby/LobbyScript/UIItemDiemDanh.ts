...
export default class UIItemDiemDanh extends cc.Component {
    ...
    getDescription(gameId) {
        ...
        switch (gameId) {
            case 191:
                des = "Tổng cược Hoa Quả 200k Tặng 1 lượt quay Dance 100";
                break;
            case 170:
                des = "Tổng cược Dance 200k Tặng 1 lượt quay Tây Du Ký 100";
                break;
            case 110:
                des = "Tổng cược Tây Du Ký 200k Tặng 1 lượt quay Night Club 100";
                break;
            case 160:
                des = "Tổng cược Night Club 200k Tặng 1 lượt quay Bóng Đá 100";
                break;
            case 150:
                des = "Tổng cược Bóng Đá 200k Tặng 1 lượt quay Night Club 100";
                break;
            case 180:
                des = "Tổng cược Sơn Tinh 200k Tặng 1 lượt quay Dance 100";
                break;
                break;
        }
        return des;
