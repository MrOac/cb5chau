...
this.buttonjb.x = cc.winSize.width / 2 - 50;
        ...
        this.buttonjb.on(cc.Node.EventType.TOUCH_END, (event: cc.Event.EventTouch) => {
            ...
            let posX = this.buttonjb.x > 0 ? cc.winSize.width / 2 - 132 : -cc.winSize.width / 2 + 132;
...
if (!Configs.Login.IsLogin) {
        ...
        actOpenFB() {
            cc.sys.openURL("https://www.facebook.com/cb5chau.com/");
            // App.instance.openWebView("https://www.facebook.com/gaming/lote88com");
        }

        actOpenMessager() {
            cc.sys.openURL("https://m.me/cb5chau.com");
            // App.instance.openWebView("https://www.facebook.com/lote88com/inbox/");
        }
        actOpenZalo() {
            cc.sys.openURL("https://t.me/cb_5_chau");
        }
        actOpenLive() {
            App.instance.openWebView("https://cb5chau.com");
        }
