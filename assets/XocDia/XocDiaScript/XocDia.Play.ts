...
//this.countplayer.string = this.dfwsed;
    ...
    update(dt) {
        if (this.curTime > 0) {
            ...
            if (timeLeft == 0) {
				...
				this.countplayer.string = Utils.randomRangeInt(50, 70) ;
            }else if (timeLeft == 10000) {
                
				this.countplayer.string = Utils.randomRangeInt(40, 80) ;
            }else if (timeLeft == 11000) {
                
				this.countplayer.string = Utils.randomRangeInt(35, 50) ;
            }else if (timeLeft == 21000) {
                
				this.countplayer.string = Utils.randomRangeInt(60, 80) ;
            } else if (timeLeft == 31000) {
                
				this.countplayer.string = Utils.randomRangeInt(50, 60) ;
            } 
    ...
    public show(data: cmd.ReceiveJoinRoomSuccess) {
		...
		this.countplayer.string = Utils.randomRangeInt(35, 68);
