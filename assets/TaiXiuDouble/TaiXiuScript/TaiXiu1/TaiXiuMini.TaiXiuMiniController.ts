...
export default class TaiXiuMiniController extends cc.Component {
	...
	@property(cc.Node)
    lblbtnbettai: cc.Node = null;
	@property(cc.Node)
    lblbtnbetxiu: cc.Node = null;
    @property(cc.Label)
    ...
    private listBets = [1000, 10000, 50000, 100000, 500000, 1000000, 5000000, 50000000];
    private readonly bowlStartPos = cc.v2(-255.042, 63.604);
        ...
        MiniGameNetworkClient.getInstance().addListener((data: Uint8Array) => {
            ...
            switch (inpacket.getCmdId()) {
                ...
                case cmd.Code.GAME_INFO: {
                    ...
                    Tween.numberTo(this.lbJackPotTai, (res.jpTai + res.jpXiu) * 10, 1.0);
    ...
    show() {
        ...
        cc.tween(this.layoutBet).to(0.5, { y: -363 }, { easing: cc.easing.sineOut }).start();
