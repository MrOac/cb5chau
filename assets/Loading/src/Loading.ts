...
export default class Loading extends cc.Component {
    ...
    listTips = [
        ...
        {
            vi: "CB5Chau.Com nạp rút nhanh chóng và an toàn!",
            en: "CB5Chau.Com quick cashin,cashout and alway safety!"
        },
    ]
    start() {
    ...
    startGame() {
        ...
        if (Configs.App.IS_LOCAL == false) {
            Http.get("https://res.cb5chau.com/assets/AssetBundleVersion.json", {}, (err, data) => {
