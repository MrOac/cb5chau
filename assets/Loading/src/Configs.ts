...
namespace Configs {
    ...
    export class App {
        ...
        static API_PAYIN_PAYWELL_BANKS: string = "https://iportal.cb5chau.com/api/payin/paywell/banks";
        static MONEY_TYPE = 1;
        static LINK_DOWNLOAD = "https://cb5chau.com/download";
        static LINK_EVENT = "https://cb5chau.com/event";
        static LINK_SUPPORT = "https://cb5chau.com";
        static USE_WSS = false;
        static LINK_GROUP = "https://www.facebook.com/groups/cb5chau";
        ...
        static getLinkFanpage() {
            switch (VersionConfig.CPName) {
                default:
                    return "https://www.facebook.com/cb5chau";
            }
        }
